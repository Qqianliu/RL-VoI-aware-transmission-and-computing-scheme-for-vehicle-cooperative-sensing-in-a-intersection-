...
def main() -> None: 
    ...
    rsu = RSU()
    state_dim = 6 # importance,  change, aoi, action(upload or not)
    ...
    with open('Accuray-test.txt', 'w', encoding='utf-8') as f:
        for item in Accuracy:
            f.write(f"{item}\n")
    with open('Decision-test.txt', 'w', encoding='utf-8') as f:
        for item in Decision:
            f.write(f"{item}\n")
    # with open('VoI-t-2.txt', 'w', encoding='utf-8') as f:
    #     for item in VoI:
    #         f.write(f"{item}\n")
    with open('EP-Reward-test.txt', 'w', encoding='utf-8') as f:
        for item in EP_reward:
            f.write(f"{item}\n")
    with open('Energy-test.txt', 'w', encoding='utf-8') as f:
        for item in E2E_energy:
            f.write(f"{item}\n")
    with open('Raw-energy-test.txt', 'w', encoding='utf-8') as f:
        for item in E2E_raw_energy:
            f.write(f"{item}\n")
    with open('Mini-energy-test.txt', 'w', encoding='utf-8') as f:
...
if __name__ == "__main__":
    Reward = main()
    with open('Reward-test.txt', 'w', encoding='utf-8') as f:
        for item in Reward:
            f.write(f"{item}\n")
